...
inline constexpr JavaFeatures::Impl_::Impl_(
    ...
    : _cached_size_{0},
      ...
      nest_in_file_class_{static_cast<
          ::pb::JavaFeatures_NestInFileClassFeature_NestInFileClass>(0)} {}
...
const char
    descriptor_table_protodef_google_2fprotobuf_2fcompiler_2fjava_2fjava_5ffeatures_2eproto
        [] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
            ...
            "tion feature.\0220\n\nlarge_enum\030\003 "
            "\001(\010B\034\210\001\001\230\001"
            "\006\230\001\001\242\001\n\022\005false\030\204\007\262\001\003"
            "\010\351\007\022Q\n\037use_old_outer"
            "_classname_default\030\004 "
            "\001(\010B(\210\001\001\230\001\001\242\001\t\022\004tru"
            "e\030\204\007\242\001\n\022\005false\030\351\007\262\001\006\010"
            "\351\007 \351\007\022\177\n\022nest_in_fi"
            "le_class\030\005 \001(\01627.pb.JavaFeatures.NestInF"
            "ileClassFeature.NestInFileClassB*\210\001\002\230\001\003\230"
            "\001\006\230\001\010\242\001\013\022\006LEGACY\030\204\007\242\001"
            "\007\022\002NO\030\351\007\262\001\003\010\351\007\032|\n\026N"
            "estInFileClassFeature\"X\n\017NestInFileClass"
            "\022\036\n\032NEST_IN_FILE_CLASS_"
            "UNKNOWN\020\000\022\006\n\002NO\020\001"
            "\022\007\n\003YES\020\002\022\024\n\006LEGACY\020\003\032\010\""
            "\006\010\351\007 \351\007J\010\010\001\020\200\200\200\200"
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<
    ...
    JavaFeatures::_table_ = {
        ...
        {{
            ...
            // optional bool large_enum = 3 [retention = RETENTION_RUNTIME,
            // targets = TARGET_TYPE_ENUM, targets = TARGET_TYPE_FILE,
            // edition_defaults = {
            {::_pbi::TcParser::SingularVarintNoZag1<
                 bool, offsetof(JavaFeatures, _impl_.large_enum_), 2>(),
             {24, 2, 0,
            ...
            {::_pbi::TcParser::SingularVarintNoZag1<
             ...
             {32, 3, 0,
              PROTOBUF_FIELD_OFFSET(JavaFeatures,
                                    _impl_.use_old_outer_classname_default_)}},
            // optional .pb.JavaFeatures.NestInFileClassFeature.NestInFileClass
            // nest_in_file_class = 5 [retention = RETENTION_SOURCE, targets =
...
::uint8_t* PROTOBUF_NONNULL JavaFeatures::_InternalSerialize(
  ...
  // optional bool large_enum = 3 [retention = RETENTION_RUNTIME, targets =
  // TARGET_TYPE_ENUM, targets = TARGET_TYPE_FILE, edition_defaults = {
...
void JavaFeatures::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  if ((cached_has_bits & 0x0000001fu) != 0) {
    ...
    if ((cached_has_bits & 0x00000008u) != 0) {
      _this->_impl_.use_old_outer_classname_default_ =
          from._impl_.use_old_outer_classname_default_;
    }
    if ((cached_has_bits & 0x00000010u) != 0) {
